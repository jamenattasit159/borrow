            ...
            <table class="table table-striped table-hover">
                ...
                <thead>
                    <tr>
                        ...
                        <th>สินค้า</th>
                        <th>ยอดต่อรอบ</th>
                        <th>วันครบกำหนดรายวัน</th>
                        <th>วันครบกำหนดรายเดือน</th>
                ...
                <tbody>
                    ...
                    if (!empty($data)) {
                        ...
                        b.product_name,
                        b.price,
                        NULLIF(b.purchase_date, '0000-00-00') AS purchase_date,
                        NULLIF(b.purchase_mount, '0000-00-00') AS purchase_mount,
                        b.instatus,
                        b.mountstatus
                    FROM users AS a
                    LEFT JOIN installment AS b ON a.uid = b.uid
                    WHERE a.uid = :uid AND (b.instatus = 'pass' OR b.mountstatus = 'pass');
                     ");
